...
class _TranslationsScreensForgotPasswordEn {
  ...
  late final _TranslationsScreensForgotPasswordPlaceholderEn placeholder =
      _TranslationsScreensForgotPasswordPlaceholderEn._(_root);
...
class _TranslationsScreensRegisterTextEn {
  ...
  String get successVerifyEmailSubtitle =>
      'Welcome to Your Ultimate Ebook Destination! Your account is created. Unlease the power of limitless choices and unmatched convenience!';
}
...
class _TranslationsScreensSettingsPurchaseEn {
  ...
  late final _TranslationsScreensSettingsPurchasePurchaseHistoryEn purchaseHistory =
      _TranslationsScreensSettingsPurchasePurchaseHistoryEn._(_root);
  late final _TranslationsScreensSettingsPurchasePendingEn pending =
      _TranslationsScreensSettingsPurchasePendingEn._(_root);
}
